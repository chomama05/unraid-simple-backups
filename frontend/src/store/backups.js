...
const devMockData = [
  {id: 1, name: 'Cummulative Backup of Secondary AppData', source: '/mnt/user/rapid_appdata', destination: '/mnt/user/Backup/rapid_appdata', frequency: 'daily', selectedTime: "23:00", type: 'cummulative', lastBackupSuccess: true},
  {id: 2, name: 'My full backup for important files', source: '/mnt/user/nextcloud', destination: '/mnt/user/Backup/nextcloud_files', frequency: 'weekly', selectedTime: "22:00", selectedDay: 5, type: 'full', lastBackupSuccess: false},
